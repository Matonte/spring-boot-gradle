...
public class User {
	...
	public User(Long userId, String firstName, String lastName, LocalDate dOB, String encryptedSSN, String email,
			String mobileTelephone, String homeAddress, String mailAddress, String accountType, int minimumBalance,
			boolean openAccount) {
		super();
		this.userId = userId;
